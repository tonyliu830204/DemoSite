...
INSERT INTO BLC_ADMIN_SECTION (ADMIN_SECTION_ID, DISPLAY_ORDER, ADMIN_MODULE_ID, NAME, SECTION_KEY, URL, USE_DEFAULT_HANDLER, CEILING_ENTITY) VALUES (-117, 1000, -16, '一键呼叫', 'Phone Info', '/phone', FALSE, 'com.appfactory.domain.PhoneInfo');
INSERT INTO BLC_ADMIN_SECTION (ADMIN_SECTION_ID, DISPLAY_ORDER, ADMIN_MODULE_ID, NAME, SECTION_KEY, URL, USE_DEFAULT_HANDLER, CEILING_ENTITY) VALUES (-119, 1000, -16, '布局', 'Layout', '/layout', FALSE, 'com.appfactory.domain.Layout');
INSERT INTO BLC_ADMIN_SECTION (ADMIN_SECTION_ID, DISPLAY_ORDER, ADMIN_MODULE_ID, NAME, SECTION_KEY, URL, USE_DEFAULT_HANDLER, CEILING_ENTITY) VALUES (-120, 1000, -16, '企业信息', 'CompanyInfo', '/company_info', FALSE, 'com.appfactory.domain.CompanyInfo');
